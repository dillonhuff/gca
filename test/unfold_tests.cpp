...
namespace gca {
  ...
  TEST_CASE("Unfold gcodes") {
    ...
    SECTION("One subroutine call") {
      ...
      block b2;
      b2.push_back(icode::make('N', 3));
      block b3;
      b3.push_back(icode::make('G', 2));
      b3.push_back(icode::make('X', 3.0));
      block b4;
      b4.push_back(icode::make('G', 0));
      b4.push_back(icode::make('Y', 2.0));
      block b5;
      b5.push_back(icode::make('M', 30));
